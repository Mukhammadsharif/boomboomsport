...
import ActiveIcon from '../images/icons/avatar_checked_icon.png';
              ...
              <ScrollView contentContainerStyle={styles.scrollView}>
                {avatars?.map((item, index) => (
                  <TouchableOpacity
                    ...
                    {avatar === item?.name ? (
                      <Image source={ActiveIcon} style={styles.circle} />
                    ) : (
                      ''
                    )}
                  </TouchableOpacity>
                ...
                <CustomButton
                  ...
                  style={{marginTop: 50, backgroundColor: COLORS.blue900}}
